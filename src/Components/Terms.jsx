        ...
        <div className="row">
          <div className="col-lg-8 col-md-10 m-auto">
            <div className="breadcrumb-content">
              <div>
                <h2 style={{ color: "#449cc0" }}> Terms &amp; Condition</h2>
                <p>
                  Rules and guidelines for using this website or mobile app.
                </p>
              </div>
            </div>
          </div>
          <div className="col-lg-8 col-md-10 m-auto">
            <div className="blog-main-content mt-0">
              <h3 style={{ color: "#449cc0" }}>Terms and Conditions</h3>
              <p>Last updated: June 16, 2023</p>
              <p>
                Please read these terms and conditions carefully before using
                Our Service.
              </p>
              <h3 className="mt-xl-5 mt-md-3 mt-2" style={{ color: "#449cc0" }}>
              ...
              <ol>
                ...
                <li>
                  <p>Country refers to: Alaska, United States</p>
                </li>
                <li>
                  <p>
                    Company(referred to as either "the Company", "We", "Us" or
                    "Our" in this Agreement) refers to megabot.
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    Website refers to megabot, accessible from{" "}
                    <a
                      data-cursor="pointer"
                      href="https://themes.pixelstrap.com/megabot/"
                      target="_blank"
                    >
                      https://themes.pixelstrap.com/megabot/
                    </a>
                  </p>
                </li>
                <li>
              ...
              <ul>
                <li>
                  <p>By email: megabot@contact.com</p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>By phone number: 4081541854</p>
                </li>
              </ul>
            </div>
          </div>
